...
func (a *App) OpenWindowSyncPanel() error {
	...
	// The independent always-on-top assistant does not require the main client
	// to be minimised. Keeping the main HWND in its normal shell state prevents
	// a hidden GDI+/tray helper from becoming the taskbar activation target.

...
var migrations = []migration{
	...
	{
		version: 7,
		desc:    "实例表添加窗口位置/尺寸记忆字段",
		stmts: []string{
			`ALTER TABLE browser_profiles ADD COLUMN last_window_x INTEGER NOT NULL DEFAULT 0`,
			`ALTER TABLE browser_profiles ADD COLUMN last_window_y INTEGER NOT NULL DEFAULT 0`,
			`ALTER TABLE browser_profiles ADD COLUMN last_window_width INTEGER NOT NULL DEFAULT 0`,
			`ALTER TABLE browser_profiles ADD COLUMN last_window_height INTEGER NOT NULL DEFAULT 0`,
		},
	},
	{
		version: 8,

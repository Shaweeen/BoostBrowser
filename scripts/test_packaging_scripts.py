...
class PackagingScriptsTest(unittest.TestCase):
    ...
    def test_startup_window_template_does_not_propagate_to_extension_popups(self):
        ...
        self.assertIn("awaitAssignedExtensionStartupTargets", startup_tabs)
        self.assertIn("extensionStartupLoadTimeout", startup_tabs)
        self.assertIn("extensionStartupCompletionWindow", startup_tabs)
        self.assertNotIn("settleBrowserStartupTabs", startup_tabs)
        self.assertNotIn("planBrowserStartupTabCleanup", startup_tabs)
